/* STUB LCM for RS070WS105A4 -- TEMPORARY build-validation placeholder (renamed copy of ili9881h_v770_hdplus_dsi_vdo_txd).
...
struct LCM_DRIVER RS070WS105A4_lcm_drv = 
{
